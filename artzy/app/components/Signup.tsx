            ...
            <div className="md:w-1/2  flex-grow flex flex-col  justify-around px-8 py-16  bg-white md:rounded-r-lg ">
                ...
                <form action={signup} >
                    <div className="flex flex-col gap-2">
                        <TextField type="text" title="Fullname" id="fullName" />
                        <TextField type="text" title="Email" id="email" />
                        <TextField type="text" title="Address" id="address" />
                        <TextField type="text" title="Phone Number" id="phoneNumber" />
                        <TextField type="password" title="Password" id="password" />

                    </div>

                    <button type="submit" className="bg-emerald-500 font-medium w-full mt-10 py-2 rounded-md text-white text-xl hover:shadow-lg ">Signup</button>

                    <p className="text-gray-500 text-sm mt-4">Have an account? <Link href='/auth/signin' className="text-emerald-500">Signin</Link></p>
                    <p className="text-gray-500 text-sm mt-8">By signing up you accept our terms of service and privacy policy. <Link href='/privacy' className="text-emerald-500 hover:text-emerald-700">Privacy policy</Link>  <Link href='/terms' className="text-emerald-500 hover:text-emerald-700">terms of service</Link></p>
